...
void MyMesh::GenerateCone(float a_fRadius, float a_fHeight, int a_nSubdivisions, vector3 a_v3Color)
{
	...
	vector3 top(a_fHeight, 0.0f, 0.0f); // the top center of the cone
	vector3 firstPoint(0.0f, a_fRadius, 0.0f); // the initial starting point
	...
	for (int i = 1; i <= a_nSubdivisions; i++) {
		...
		vector3 point(0.0f, cos(currentDegree) * a_fRadius, sin(currentDegree) * a_fRadius);
		vecArray[i] = point;
