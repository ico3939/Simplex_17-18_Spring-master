...
class Application
{
	...
	std::vector<float> m_TimerList; // a list to hold separate timers for each orbit
	std::vector<std::vector<vector3>> m_allStops; // a vector to hold each of the stops in the orbit
