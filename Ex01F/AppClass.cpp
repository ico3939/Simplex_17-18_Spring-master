...
#pragma endregion
	...
	m_sProgrammer = "Ian Oliver - ico3939@g.rit.edu"; //Replace with your name and email
	...
	if (fPercentage >= 1.0f)
	{
		...
		route %= m_v3StopList.size();//make sure we are within boundries
	}
...
void Application::InitVariables(void)
{
	...
	m_pMesh->GenerateCone(1.5f, 2.0f, 20, C_YELLOW);
